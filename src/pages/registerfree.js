...
const RegisterFreePage = () => {
  ...
  try {
    ...
    if (formData.membership_level === 1) {
      await axios.post("https://menubackend-git-main-yashkolnures-projects.vercel.app/api/admin/restaurants", formData);
      ...
      const { data } = await axios.post("https://menubackend-git-main-yashkolnures-projects.vercel.app/api/create-order", {
        amount,
        currency: "INR",
      });
      ...
      const options = {
        ...
        handler: async function (response) {
          try {
            const verifyRes = await axios.post("https://menubackend-git-main-yashkolnures-projects.vercel.app/api/verify-payment", {
